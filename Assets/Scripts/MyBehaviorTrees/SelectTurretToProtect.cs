...
public class SelectTurretToProtect : Action
{
	...
	public override TaskStatus OnUpdate()
	{
		...
		target.Value = m_ArmyElement.ArmyManager.GetTurretToProtect((ArmyElement) GetComponent(typeof(ArmyElement)))?.transform;
